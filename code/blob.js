(() => {
    ...
    if ((e && typeof e == "object") || typeof e == "function")
      for (let r of S(e))
        !E.call(t, r) &&
          ...
          m(t, r, {
            get: () => e[r],
            enumerable: !(n = O(e, r)) || n.enumerable,
          });
    return t;
  };
  var V = t =>
      ...
      G(
        m(
          ...
          t && t.__esModule && "default" in t
            ? { get: () => t.default, enumerable: true }
            : { value: t, enumerable: true }
        )
      ),
      t
    );
    ...
    (function () {
      ...
      (t.prototype.split = function () {
        var e = this.level + 1,
          ...
          r = this.bounds.height / 2,
          s = this.bounds.x,
          i = this.bounds.y;
        (this.nodes[0] = new t(
          { x: s + n, y: i, width: n, height: r },
          this.max_objects,
          this.max_levels,
          e
        )),
          (this.nodes[1] = new t(
            { x: s, y: i, width: n, height: r },
            this.max_objects,
            this.max_levels,
            e
          )),
          (this.nodes[2] = new t(
            { x: s, y: i + r, width: n, height: r },
            this.max_objects,
            this.max_levels,
            e
          )),
          (this.nodes[3] = new t(
            { x: s + n, y: i + r, width: n, height: r },
            this.max_objects,
            this.max_levels,
            e
          ));
        ...
        (t.prototype.insert = function (e) {
          ...
          if (
            ...
            for (
              this.nodes.length || this.split(), n = 0;
        ...
        typeof x != "undefined" && typeof x.exports != "undefined"
          ? (x.exports = t)
          : (window.Quadtree = t);
    })();
  });
  function W(t, e) {
    if (
      ((t = [...t]),
      Array.isArray(t[0]) || (t = t.map(({ x: n, y: r }) => [n, r])),
      e)
    ) {
      let n = t[t.length - 1],
        r = t[t.length - 2],
